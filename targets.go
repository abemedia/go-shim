...
var Rust = []Target{
	...
	{GOOS: "linux", GOARCH: "386", GO386: "sse2", Names: []string{"i686-unknown-linux-musl", "i686-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "386", Names: []string{"i586-unknown-linux-musl", "i586-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "amd64", Names: []string{"x86_64-unknown-linux-musl", "x86_64-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "7", Names: []string{"armv7-unknown-linux-musleabihf", "armv7-unknown-linux-gnueabihf"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "6", Names: []string{"arm-unknown-linux-musleabihf", "arm-unknown-linux-gnueabihf"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "7,softfloat", Names: []string{"armv7-unknown-linux-musleabi", "armv7-unknown-linux-gnueabi"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "6,softfloat", Names: []string{"arm-unknown-linux-musleabi", "arm-unknown-linux-gnueabi"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "5", Names: []string{"armv5te-unknown-linux-musleabi", "armv5te-unknown-linux-gnueabi"}},
	{GOOS: "linux", GOARCH: "arm64", Names: []string{"aarch64-unknown-linux-musl", "aarch64-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "loong64", Names: []string{"loongarch64-unknown-linux-musl", "loongarch64-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "mips", Names: []string{"mips-unknown-linux-musl"}},
	{GOOS: "linux", GOARCH: "mips", GOMIPS: "hardfloat", Names: []string{"mips-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "mips64", GOMIPS64: "hardfloat", Names: []string{"mips64-unknown-linux-muslabi64", "mips64-unknown-linux-gnuabi64"}},
	{GOOS: "linux", GOARCH: "mips64le", GOMIPS64: "hardfloat", Names: []string{"mips64el-unknown-linux-muslabi64", "mips64el-unknown-linux-gnuabi64"}},
	{GOOS: "linux", GOARCH: "mipsle", Names: []string{"mipsel-unknown-linux-musl"}},
	{GOOS: "linux", GOARCH: "mipsle", GOMIPS: "hardfloat", Names: []string{"mipsel-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "ppc64", Names: []string{"powerpc64-unknown-linux-musl", "powerpc64-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "ppc64le", Names: []string{"powerpc64le-unknown-linux-musl", "powerpc64le-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "riscv64", Names: []string{"riscv64gc-unknown-linux-musl", "riscv64gc-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "s390x", Names: []string{"s390x-unknown-linux-musl", "s390x-unknown-linux-gnu"}},
...
// Zig names builds by Zig target triple, with and without the libc or none suffix.
var Zig = []Target{
	...
	{GOOS: "linux", GOARCH: "386", GO386: "sse2", Names: []string{"x86-linux-musl", "x86-linux-gnu", "x86-linux"}},
	{GOOS: "linux", GOARCH: "amd64", Names: []string{"x86_64-linux-musl", "x86_64-linux-gnu", "x86_64-linux"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "7", Names: []string{"arm-linux-musleabihf", "arm-linux-gnueabihf", "arm-linux", "arm-linux-musleabi", "arm-linux-gnueabi"}},
	{GOOS: "linux", GOARCH: "arm64", Names: []string{"aarch64-linux-musl", "aarch64-linux-gnu", "aarch64-linux"}},
	{GOOS: "linux", GOARCH: "loong64", Names: []string{"loongarch64-linux-musl", "loongarch64-linux-gnu", "loongarch64-linux"}},
	{GOOS: "linux", GOARCH: "mips", GOMIPS: "hardfloat", Names: []string{"mips-linux-musleabihf", "mips-linux-gnueabihf", "mips-linux"}},
	{GOOS: "linux", GOARCH: "mips", Names: []string{"mips-linux-musleabi", "mips-linux-gnueabi"}},
	{GOOS: "linux", GOARCH: "mips64", GOMIPS64: "hardfloat", Names: []string{"mips64-linux-muslabi64", "mips64-linux-gnuabi64", "mips64-linux"}},
	{GOOS: "linux", GOARCH: "mips64le", GOMIPS64: "hardfloat", Names: []string{"mips64el-linux-muslabi64", "mips64el-linux-gnuabi64", "mips64el-linux"}},
	{GOOS: "linux", GOARCH: "mipsle", GOMIPS: "hardfloat", Names: []string{"mipsel-linux-musleabihf", "mipsel-linux-gnueabihf", "mipsel-linux"}},
	{GOOS: "linux", GOARCH: "mipsle", Names: []string{"mipsel-linux-musleabi", "mipsel-linux-gnueabi"}},
	{GOOS: "linux", GOARCH: "ppc64", Names: []string{"powerpc64-linux-musl", "powerpc64-linux-gnu", "powerpc64-linux"}},
	{GOOS: "linux", GOARCH: "ppc64le", Names: []string{"powerpc64le-linux-musl", "powerpc64le-linux-gnu", "powerpc64le-linux"}},
	{GOOS: "linux", GOARCH: "riscv64", Names: []string{"riscv64-linux-musl", "riscv64-linux-gnu", "riscv64-linux"}},
	{GOOS: "linux", GOARCH: "s390x", Names: []string{"s390x-linux-musl", "s390x-linux-gnu", "s390x-linux"}},
...
var Node = []Target{
	...
	{GOOS: "linux", GOARCH: "386", GO386: "sse2", Names: []string{"linux-ia32-musl", "linux-ia32-gnu", "linux-ia32"}},
	{GOOS: "linux", GOARCH: "amd64", Names: []string{"linux-x64-musl", "linux-x64-gnu", "linux-x64"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "7", Names: []string{"linux-arm-musleabihf", "linux-arm-gnueabihf", "linux-arm"}},
	{GOOS: "linux", GOARCH: "arm64", Names: []string{"linux-arm64-musl", "linux-arm64-gnu", "linux-arm64"}},
	{GOOS: "linux", GOARCH: "loong64", Names: []string{"linux-loong64-musl", "linux-loong64-gnu", "linux-loong64"}},
	{GOOS: "linux", GOARCH: "ppc64le", Names: []string{"linux-ppc64-musl", "linux-ppc64-gnu", "linux-ppc64"}},
	{GOOS: "linux", GOARCH: "riscv64", Names: []string{"linux-riscv64-musl", "linux-riscv64-gnu", "linux-riscv64"}},
	{GOOS: "linux", GOARCH: "s390x", Names: []string{"linux-s390x-musl", "linux-s390x-gnu", "linux-s390x"}},
...
var Deno = []Target{
	{GOOS: "darwin", GOARCH: "amd64", Names: []string{"x86_64-apple-darwin"}},
	{GOOS: "darwin", GOARCH: "arm64", Names: []string{"aarch64-apple-darwin"}},
	{GOOS: "linux", GOARCH: "amd64", Names: []string{"x86_64-unknown-linux-gnu"}},
	{GOOS: "linux", GOARCH: "arm64", Names: []string{"aarch64-unknown-linux-gnu"}},
...
var Bun = []Target{
	...
	{GOOS: "linux", GOARCH: "amd64", Names: []string{"linux-x64-musl", "linux-x64"}},
	{GOOS: "linux", GOARCH: "arm64", Names: []string{"linux-arm64-musl", "linux-arm64"}},
	{GOOS: "windows", GOARCH: "amd64", Names: []string{"windows-x64"}},
	{GOOS: "windows", GOARCH: "arm64", Names: []string{"windows-arm64"}},
}

// DotNet names builds by .NET runtime identifier, as dotnet publish -r does.
var DotNet = []Target{
	...
	{GOOS: "linux", GOARCH: "amd64", Names: []string{"linux-musl-x64", "linux-x64"}},
	{GOOS: "linux", GOARCH: "arm", GOARM: "7", Names: []string{"linux-musl-arm", "linux-arm"}},
	{GOOS: "linux", GOARCH: "arm64", Names: []string{"linux-musl-arm64", "linux-arm64"}},
	{GOOS: "linux", GOARCH: "loong64", Names: []string{"linux-loongarch64"}},
	{GOOS: "linux", GOARCH: "ppc64le", Names: []string{"linux-ppc64le"}},
...
// Dart names builds the way the Dart SDK does, as dart compile exe projects tend to.
var Dart = []Target{
